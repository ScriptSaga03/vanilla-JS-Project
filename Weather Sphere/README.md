...
**Atmospheric UI:** Uses a custom switch logic to detect weather conditions and update the entire theme (colors/icons) dynamically.
**Glassmorphism Design:** Modern UI with backdrop filters and responsive grids that work perfectly on mobile devices.
**State Management:** Uses an app object to manage timers and UI states, preventing memory leaks and overlapping messages.
